...
void CVRICommands::blitToSwapchain(const TFrail<SVRIImage>& inSource, const TFrail<SSwapchainImage>& inDestination, const Extent32u inSrcSize, const Extent32u inDstSize) const {
	ZoneScopedN("Image Blit");
...
void CVRICommands::transitionSwapchainImage(const TFrail<SSwapchainImage>& inImage, VkImageLayout inLayout) {
	ZoneScopedN("Transition Swapchain Image");
