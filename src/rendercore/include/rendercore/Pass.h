...
public:
	...
	EXPORT void bindPipeline(const TFrail<CVRICommands>& cmd, const TFrail<SPipeline>& inPipeline, const struct SPushConstants& inConstants);
...
private:
	...
	TFrail<SPipeline> m_CurrentPipeline = nullptr;
};