...
struct SRenderStack {
	...
	SRenderStack& mul(const Matrix4f& inTransform) {
		m_MatrixStack.top() *= inTransform;
		return *this;
	}
...
struct SRenderStack2f : SRenderStack {
...
struct SRenderStack3f : SRenderStack {
